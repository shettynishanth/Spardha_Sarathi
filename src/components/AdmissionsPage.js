...
const AdmissionsPage = () => {
  return (
    <div className="relative w-full min-h-[60vh] md:min-h-screen flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-blue-50 to-blue-100 text-black px-6 md:px-36 pt-14 md:pt-16 overflow-hidden">
      {/* Left Section (Text) */}
