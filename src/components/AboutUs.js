...
const AboutUs = () => {
  ...
  <span className="custom-underline"></span>
        ...
        <p className="text-lg text-gray-600 mb-4 text-center leading-relaxed">
          ...
          professionals, we offer a holistic approach to preparing candidates for the kAS exams.
        </p>
        ...
        <p className="text-lg text-gray-600 mb-4 text-center leading-relaxed">
  <span className="font-semibold text-blue-900">ಸ್ಪರ್ಧಾ ಸರಥಿ KAS Academy</span> ನಲ್ಲಿ, ನಾವು ಸರ್ಕಾರಿ ಸೇವೆಗಾಗಿ ಅಗತ್ಯವಿರುವ ಅಭ್ಯರ್ಥಿಗಳ ಭವಿಷ್ಯವನ್ನು ರೂಪಿಸಲು ಸಮಗ್ರ ತರಬೇತಿ ಮತ್ತು ಮಾರ್ಗದರ್ಶನಕ್ಕೆ ಬದ್ಧರಾಗಿದ್ದೇವೆ. ಅನುಭವಿತ ಶಿಕ್ಷಕರ ಮತ್ತು ವೃತ್ತಿಪರರ ತಂಡವನ್ನು ಹೊಂದಿರುವ ನಾವು, KAS ಪರೀಕ್ಷೆಗಳಿಗೆ ಅಭ್ಯರ್ಥಿಗಳನ್ನು ತಯಾರಿಸಲು ಸಮಗ್ರ ದೃಷ್ಟಿಕೋನವನ್ನು ಒದಗಿಸುತ್ತೇವೆ.
</p>
<p className="text-lg text-gray-600 mb-8 text-center leading-relaxed">
  ಸರ್ಕಾರಿ ಸೇವೆಯಲ್ಲಿ ಉದ್ಯೋಗವನ್ನು ಹುಡುಕಲು ಅವಶ್ಯಕವಾದ ಜ್ಞಾನ ಮತ್ತು ಕೌಶಲ್ಯಗಳನ್ನು ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ಶಕ್ತಿ ನೀಡುವುದು ನಮ್ಮ ಉದ್ದೇಶವಾಗಿದೆ. ಆಲೋಚನೆಯ ಮೇಲ್ವಿಚಾರಣೆ, ಕ್ರಿಯಾತ್ಮಕತೆಯನ್ನು ಉತ್ತೇಜಿಸುವ ಮತ್ತು ವೈಯಕ್ತಿಕ ಬೆಳವಣಿಗೆಗೆ ಉತ್ತೇಜನ ನೀಡುವ ಬೆಂಬಲದ ಕಲಿಕೆ ಪರಿಸರವನ್ನು ಬೆಳೆಸುವ ಮೇಲೆ ನಾವು ನಂಬಿದ್ದೇವೆ.
</p>
  ...
  <div className="text-lg text-gray-700 leading-relaxed text-center lg:text-left p-6 lg:p-10">
    ...
    <p className="mb-6">
  <span className="font-semibold">ಸ್ಪರ್ಧಾ ಸರಥಿ KAS Academy ಕುಂದಾಪುರ</span> ಅನ್ನು ಪರಿಚಯಿಸಲು ನಮಗೆ ಗೌರವವಾಗಿದೆ, IAS, KAS, SSC, IBPS, RRB ಮತ್ತು ಇತರ ಸ್ಪರ್ಧಾತ್ಮಕ ಪರೀಕ್ಷೆಗಳಿಗಾಗಿ ಸಾವಿರಾರು ವಿದ್ಯಾರ್ಥಿಗಳನ್ನು ತಯಾರಿಸಲು ಹೆಸರುವಾಸಿಯಾಗಿರುವ ಆಧ್ಯಾಯಕರಾಗಿರುವ ಸಂಸ್ಥೆ. ಕಳೆದ ವರ್ಷಗಳಲ್ಲಿ, ನಾವು ಈ ಸವಾಲುಗಳುಗಳನ್ನು ಉತ್ತೀರ್ಣಗೊಳ್ಳಲು ಬಯಸುವ ಯುವ ಆಕಾಂಕ್ಷಿಗಳಿಗೆ ಪ್ರಧಾನ ಆಯ್ಕೆಯಾಗಿದ್ದೇವೆ.
</p>
<p className="mb-6">
  ಹಿಂದಿನ ಪರೀಕ್ಷೆಯ ಕಾಗದಗಳು ಪರೀಕ್ಷಾ ಮಾದರಿಗಳ ಉತ್ತಮ ಒಳನೋಟವನ್ನು ನೀಡುತ್ತವೆ ಎಂದು ನಾವು ಗುರುತಿಸುತ್ತೇವೆ. ಆದರೆ, ವಾಸ್ತವದಲ್ಲಿ ಯಶಸ್ಸು ಒಬ್ಬ ಸಮಗ್ರ ದೃಷ್ಟಿಕೋನದಿಂದ ಬರುತ್ತದೆ—ತಜ್ಞ ಮಾರ್ಗದರ್ಶನದಲ್ಲಿ ತೀವ್ರ ತಯಾರಿ, ಸಂಪೂರ್ಣ ಅಧ್ಯಯನ ಸಾಮಗ್ರಿಗಳು ಮತ್ತು ಶ್ರೇಷ್ಠ ಗ್ರಂಥಾಲಯ ಸಂಪತ್ತುಗಳ ಮೂಲಕ. ಈ ಸಂಯೋಜನೆಯು ಸಾಧನೆಗೆ ಸುಲಭವಾಗಿ ಸಾಗುತ್ತದೆ.
</p>
<p className="mb-6">
  <span className="font-semibold">ಸ್ಪರ್ಧಾ ಸರಥಿ KAS Academy ಕುಂದಾಪುರ</span> ನಲ್ಲಿ, ನಿಮ್ಮ ಪಯಣದಲ್ಲಿ ಎಲ್ಲಾ ಅಂಶಗಳಲ್ಲಿ ಉತ್ತಮತೆಗೆ ಬದ್ಧರಾಗಿದ್ದೇವೆ, ಅದು ಅಧ್ಯಯನ ಪರಿಸರ, ಶಿಕ್ಷಣದ ಗುಣಮಟ್ಟ, ಅಧ್ಯಯನ ಸಾಮಗ್ರಿಗಳ ಗುಣಮಟ್ಟ, ಪರೀಕ್ಷಾ ಶ್ರೇಣಿಯ ತೀವ್ರತೆ ಅಥವಾ ಮಾರ್ಗದರ್ಶನ ಮತ್ತು ಮಾಹಿತಿಯ ಆಳವನ್ನು ಮಾತ್ರವಲ್ಲ. ಒಂದು ದಶಕದಿಂದ ಹೆಚ್ಚು, ನಮ್ಮ ಸಂಸ್ಥೆಯು ಯಶಸ್ಸಿನ ಏಕಕಾಲದ ಮಿತಿ ಸ್ಥಾಪಿಸಿದೆ, ಮತ್ತು ನಮ್ಮ ನಾವೀನ್ಯತೆಯ ವಿಧಾನಗಳು ಮತ್ತು ನಿರಂತರ ಬದ್ಧತೆಯೊಂದಿಗೆ, ನಾವು ಶ್ರೇಷ್ಠ ಗುಣಮಟ್ಟದ ಶಿಕ್ಷಣವನ್ನು ನೀಡುವಲ್ಲಿ ಮುಂಚೂಣಿಯಲ್ಲಿಯೇ ಇರುತ್ತೇವೆ.
</p>
<p>
  ನಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳಲ್ಲಿನ ಸಾಮರ್ಥ್ಯ ಮತ್ತು ಚಾಲನೆಯನ್ನು ಬೆಳೆಸಬೇಕು, ಮಾರ್ಗದರ್ಶನ ಮಾಡಬೇಕು ಮತ್ತು ಸರಿಯಾದ ದಿಕ್ಕಿನಲ್ಲಿ ಚಾನಲ್ ಮಾಡಲು ನಮಗೆ ನಂಬಿಕೆ ಇದೆ. ಒಂದಾಗಿ, ನಾವು ನಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳನ್ನು ಉದ್ಯೋಗಕ್ಕಾಗಿ ಸಾಧಿಸಲು ಮಾತ್ರ ಸಹಾಯ ಮಾಡುವುದಲ್ಲ, ಸಮಾಜದಲ್ಲಿ ಪರಿಣಾಮಕಾರಿಯುತ ವ್ಯಕ್ತಿಗಳಾಗಲು ಅವರುಗಳಿಗೆ ಅಧಿಕಾರವನ್ನು ನೀಡಲು ಸಹ ಪ್ರಯತ್ನಿಸುತ್ತೇವೆ. ಅವರ ಯಶಸ್ಸಿನಲ್ಲಿ ಹೂಡಿಕೆ ಮಾಡುವುದು ಮೂಲಕ, ನಾವು ಎಲ್ಲಾ ಸಮಾಜಕ್ಕೆ ಒಂದು ಪ್ರಭಾವಿ ಭವಿಷ್ಯಕ್ಕೆ ಸಹಾಯ ಮಾಡುತ್ತೇವೆ.
</p>
